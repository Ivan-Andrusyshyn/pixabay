...
authRoutes.post('/signup', (0, user_1.default)('name', 'email'), validateFilter_1.default, signup_1.default);
authRoutes.post('/signin', (0, user_1.default)('name', 'email'), validateFilter_1.default, jwt_token_1.default, signin_1.default);
